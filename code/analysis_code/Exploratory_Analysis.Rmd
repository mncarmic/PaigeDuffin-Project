...
ggsave(filename = "../../results/Exploratory_Analysis_results/Abundance_State_Year_graphs.png",plot = Abundance_State_Year_graphs, width = 5, height = 4) 
```
...
#### Abundance over time
```{r}
abundance_time_boxplots <- clean_data %>% ggplot(aes(marine_common_year, log(total), group = marine_common_year)) + 
...
```{r}
ggsave(filename = "../../results/Exploratory_Analysis_results/abundance_time_boxplots.png",plot = abundance_time_boxplots, width = 5, height = 4) 
```
...
ggsave(filename = "../../results/Exploratory_Analysis_results/P.ochra_only_boxplot.png",plot = P.ochra_only_boxplot, width = 5, height = 4)
```
...
ggsave(filename = "../../results/Exploratory_Analysis_results/K.tuni_only_boxplot.png",plot = K.tuni_only_boxplot, width = 5, height = 4)
```

```{r}
E.tros_only_boxplot <- E.tros_only %>% ggplot(aes(marine_common_year, log(total), group = marine_common_year)) + geom_boxplot(fill = "skyblue3", alpha = 0.4) +
  xlab("Year") + 
  ylab("log(E.troschelii Abundance)")  
E.tros_only_boxplot

ggsave(filename = "../../results/Exploratory_Analysis_results/E.tros_only_boxplot.png",plot = E.tros_only_boxplot, width = 5, height = 4)
```
...
ggsave(filename = "../../results/Exploratory_Analysis_results/P.ochra_SSWD_tf_plot.png",plot = P.ochra_SSWD_tf_plot, width = 5, height = 4)
```
...
ggsave(filename = "../../results/Exploratory_Analysis_results/K.tuni_SSWD_tf_plot.png",plot = K.tuni_SSWD_tf_plot, width = 5, height = 4)
```

```{r}
E.tros_SSWD_tf_plot <- E.tros_SSWD_tf %>% ggplot(aes(marine_common_year, log(total), group = marine_common_year)) + geom_boxplot(fill = "skyblue3", alpha = 0.4) +
  xlab("Year") + 
  ylab("log(E.troschelii Abundance)")  
E.tros_SSWD_tf_plot

ggsave(filename = "../../results/Exploratory_Analysis_results/E.tros_SSWD_tf_plot.png",plot = E.tros_SSWD_tf_plot, width = 5, height = 4)
```
...
Season_year_boxplot
ggsave(filename = "../../results/Exploratory_Analysis_results/Season_year_boxplot.png",plot = grid.arrange(P.ochra_SSWD_tf_fig, K.tuni_SSWD_tf_fig, nrow=2), width = 5, height = 4)
```
...
ggsave(filename = "../../results/Exploratory_Analysis_results/P.ochra_SSWDtf_by_state.png",plot = P.ochra_SSWD_tf_fig + facet_wrap(~ state), width = 5, height = 4)
