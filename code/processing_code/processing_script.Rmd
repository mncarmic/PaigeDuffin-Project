...
group_code_histogram <- SS_count %>% ggplot2::ggplot() + geom_bar(aes(group_code))
group_code_histogram
ggsave(filename = "../../results/Processing_results/group_code_histogram.png",plot = group_code_histogram, width = 5, height = 4) 
```
...
saveRDS(numeric_sites_code_key, file = "../../data/processed_data/numeric_sites_code_key.rds")
```
...
saveRDS(numeric_seasons_code_key, file = "../../data/processed_data/numeric_seasons_code_key.rds")
```
...
saveRDS(season_sequence_key, file = "../../data/processed_data/season_sequence_key.rds")
```
